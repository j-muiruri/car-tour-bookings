...
<head>
    ...
    <!--=== Favicon ===-->
    <link rel="shortcut icon" href="favicon.ico" type="image/x-ic on" />

    <title>Oops! We could not find the <?php echo $resource; ?> </title>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="page-404-content">
                    	...
                    	<h4><?php  echo $resource; ?> NOT FOUND !</h4>
                    	<p>SORRY, WE COULDN'T FIND THE  <?php  echo $resource; ?> <br> YOU'RE LOOKING.</p>
