...
<script type="text/javascript">
    (function () {
        var options = {
            whatsapp: "254716628034", // WhatsApp number
            call_to_action: "Start Chat", // Call to action
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-footer-widget">
                            <h2>get touch</h2>
                            <div class="widget-body">
                                <p>Give us a call or send us an email & a team member will be in touch.</p>

                                <ul class="get-touch">
                                    <li><i class="fa fa-map-marker"></i>Ruaka, Along Limuru Road</li>
